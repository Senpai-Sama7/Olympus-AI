...
# Timeout
app.add_middleware(TimeoutMiddleware, connect_timeout=settings.CONNECT_TIMEOUT_SEC, request_timeout=settings.REQUEST_TIMEOUT_SEC)
...
async def _metrics_middleware(request: Request, call_next):
	...
	with request_duration_seconds.labels(path=path, method=method, status="_pending").time():
